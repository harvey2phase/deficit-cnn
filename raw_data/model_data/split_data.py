...
death_year_filename = "e4_death_year.txt"
raw_deficits_filename = "../../spencer_code/Data/"
raw_deficits_filename += "RawDeficitsID1Gammap7.5Gamman6.5N10000Number10000R3."
...
def main():
    ...
    for change in range(0, raw_length - 1):
        f.write(
            str(change_time[change]) + "\t" +
            str(int(node_id[change])) + "\t"
        )
