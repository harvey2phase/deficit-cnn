...
def plot(filename, input_dir, output_dir, id_deg, rank_deg):
...
def plot_decade(death_decade):
    ...
    output_dir = death_decade + '0_20_nodes_rank/'
    ...
    for i in range(10):
        ...
        while os.path.isfile(input_dir + filename + ".txt"):
            print(filename + ".txt")
            plot(filename, input_dir, output_dir, id_deg, rank_deg)
